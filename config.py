...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1925150914:AAEbu3JmabTwqi7EH4hSXG3rrvHzWHHJOq8' # Get it from https://t.me/BotFather
    APP_ID = '1856761' # Get it from my.telegram.org/apps
    API_HASH = '287279f4045af3c66c717d41a70e0ade' # Get it from my.telegram.org/apps
